...
namespace Viblog.Data.CosmosDb.Data.Seeders;
...
public static class BlogPostSeeder
{
    ...
    public static async Task SeedAsync(ApplicationDbContext context)
    {
        ...
        post1.SetPartitionKey(); // Set partition key based on publication year
        ...
        int readingTime)
    {
        ...
        post.SetPartitionKey(); // Set partition key based on publication year
        return post;
    }
}
