...
/// </summary>
public class CosmosDbMediaMetadataRepository : CosmosDbRepository<MediaItem>, IMediaMetadataRepository
{
    public CosmosDbMediaMetadataRepository(ApplicationDbContext context) : base(context)
    {
    }
