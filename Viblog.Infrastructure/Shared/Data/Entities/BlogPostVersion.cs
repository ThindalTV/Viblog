...
/// <summary>
/// Persisted version snapshot for BlogPost content.
/// Stored separately from BlogPost entity for scalability.
/// </summary>
public class BlogPostVersion : BaseEntity
{
    /// <summary>
    ...
    /// </summary>
    public new string GroupKey { get; set; } = "BlogPostVersion";
}
